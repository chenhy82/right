...
namespace Langben.DAL
{
    ...
    public partial class SysMessageRepository : BaseRepository<SysMessage>, IDisposable
    {
        ...
        /// <returns></returns>      
        public IQueryable<SysMessage> DaoChuData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
        ...
        /// <param name="id">主键</param>
        /// <returns>短信发送记录</returns>
        public SysMessage GetById(SysEntities db, string id)
        { 
        ...
        /// <returns></returns>
        public IQueryable<SysMessage> GetByRefSysMessageTempId(SysEntities db, string id)
        {

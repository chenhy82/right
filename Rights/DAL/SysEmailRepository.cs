...
namespace Langben.DAL
{
    ...
    public partial class SysEmailRepository : BaseRepository<SysEmail>, IDisposable
    {
        ...
        /// <returns></returns>      
        public IQueryable<SysEmail> DaoChuData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
        ...
        /// <param name="id">主键</param>
        /// <returns>邮件发送记录</returns>
        public SysEmail GetById(SysEntities db, string id)
        { 
        ...
        /// <returns></returns>
        public IQueryable<SysEmail> GetByRefSysMailId(SysEntities db, string id)
        {

...
namespace Langben.DAL
{
    ...
    public partial class SysMessageTempRepository : BaseRepository<SysMessageTemp>, IDisposable
    {
        ...
        /// <returns></returns>      
        public IQueryable<SysMessageTemp> DaoChuData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
        ...
        /// <param name="id">主键</param>
        /// <returns>短信模板</returns>
        public SysMessageTemp GetById(SysEntities db, string id)
        { 
